...
routes['POST']['/users'] = 'Users#create_user'
routes['/songs'] = 'Users#display_songs'
routes['/songs/<id>'] = 'Users#display_song_info'
routes['POST']['/login'] = 'Users#login'
routes['POST']['/new'] = 'Users#add_song'
routes['/logout'] = 'Users#logout'
routes['POST']['/add/<id>'] = 'Users#add_playlist_song'
routes['/users/<user_id>'] = 'Users#display_user'
